        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {workerData?.status === 'unverified' && (
            <div className="bg-amber-50 border border-amber-300 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-amber-800">Your profile is pending approval</p>
                <p className="text-amber-700 text-sm mt-0.5">Our admin team is reviewing your profile. You won't appear in search results until you're verified. This usually takes a short time.</p>
              </div>
            </div>
          )}
