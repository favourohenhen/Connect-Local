  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        navigate('/dashboard'); // Always redirect to dashboard for logged in workers
      }
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative">
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 mt-10 sm:mt-0">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Welcome Back, Pro</h2>
