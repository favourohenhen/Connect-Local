...
BEGIN
  ...
  INSERT INTO public.workers (
    ...
    (w1, 'Electrician', 'Urumwon', 'Mechanic Road',
     ...
     '08031110001', 94, 21,
     'Panel Installation, Fault Finding, Rewiring, Generator Connection'),
    ...
    (w2, 'Plumber', 'Urumwon', 'Osakue Road',
     ...
     '08031110002', 91, 18,
     'Pipe Fitting, Leak Repair, Water Heater, Drainage'),
    ...
    (w3, 'Carpenter', 'Urumwon', 'Opposite Urumwon Primary School',
     ...
     '08031110003', 89, 15,
     'Custom Furniture, Wardrobes, Door Frames, Wood Polish'),
    ...
    (w4, 'Painting & Design', 'Urumwon', 'Idada Street',
     ...
     '08031110004', 86, 12,
     'Interior Painting, Exterior Painting, Wallpapers, POP Finishing'),
    ...
    (w5, 'Welder', 'Urumwon', 'Groundnut Junction',
     ...
     '08031110005', 88, 9,
     'Gate Fabrication, Iron Doors, Burglar Proof, Arc Welding'),
    ...
    (w6, 'Baker', 'Urumwon', 'Mechanic Road',
     ...
     '08031110006', 92, 24,
     'Birthday Cakes, Chin-Chin, Puff Puff, Small Chops, Bread'),
    ...
    (w7, 'Tailor / Fashion Designer', 'Urumwon', 'Osakue Road',
     ...
     '08031110007', 93, 27,
     'Native Wear, Corporate Outfits, Uniforms, Alterations'),
    ...
    (w8, 'Hair Stylist', 'Urumwon', 'Opposite Urumwon Primary School',
     ...
     '08031110008', 90, 31,
     'Braiding, Weave-On, Natural Hair, Relaxer, Styling'),
    ...
    (w9, 'Barber', 'Urumwon', 'Idada Street',
     ...
     '08031110009', 87, 19,
     'Low Cut, Fade, Beard Grooming, Mobile Barbing'),

    -- 10. House Cleaner – Amaka Uche
    (w10, 'House Cleaner', 'Urumwon', 'Groundnut Junction',
     true, 'verified', 4,
     ...
     '08031110010', 85, 16,
     'Deep Cleaning, Kitchen Cleaning, Bathroom, Move-In Clean'),
    ...
    (w11, 'Laundry & Dry Cleaning', 'Urumwon', 'Mechanic Road',
     ...
     '08031110011', 82, 11,
     'Ironing, Dry Cleaning, Stain Removal, Native Wear'),
    ...
    (w12, 'Phone & Computer Repair', 'Urumwon', 'Osakue Road',
     ...
     '08031110012', 78, 6,
     'Screen Replacement, Battery Fix, Software Repair, Laptop')
  ...
  -- Welder (Sunday Okoro)
  INSERT INTO public.worker_portfolios (worker_id, image_url, description) VALUES
    (w5, 'https://images.unsplash.com/photo-1565043666747-69f6646db940?auto=format&fit=crop&w=600&q=80', 'Security gate fabricated'),
    (w5, 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=600&q=80', 'Iron door installation'),
    (w5, 'https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?auto=format&fit=crop&w=600&q=80', 'Arc welding close-up');
  ...
  -- Barber (Ifeanyi Eze)
  INSERT INTO public.worker_portfolios (worker_id, image_url, description) VALUES
    (w9, 'https://images.unsplash.com/photo-1582095133179-bfd08e2fb6b8?auto=format&fit=crop&w=600&q=80', 'Skin fade haircut'),
  ...
  INSERT INTO public.worker_portfolios (worker_id, image_url, description) VALUES
    (w10, 'https://images.unsplash.com/photo-1527515637-ed21f642436d?auto=format&fit=crop&w=600&q=80', 'Deep kitchen clean'),
